    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-white overflow-hidden">
      ...
      >
        ...
        <p className="text-gray-500 text-center mb-10">
          20가지 여행 MBTI 테스트 문항을 통해 나의 여행 취향 결과를
          확인해보세요!
        </p>
      </div>

      {/* Icon Section */}
      <img src={HandIcon} alt="손가락 아이콘" className="h-40 w-auto mb-10" />
      ...
      >
        <div className="grid grid-cols-2 gap-4 mb-10">
          {/* Option 1 */}
          <div className="p-6 border rounded-lg flex flex-col items-center transform transition-transform duration-300">
          ...
          {/* Option 2 */}
          <div className="p-6 border rounded-lg flex flex-col items-center transform transition-transform duration-300 bg-blue-100">
      ...
      >
        <button
          className="bg-blue-500 text-white font-semibold py-3 px-8 rounded-lg shadow-md hover:bg-blue-600"
