...
export const registerTravel = async (requestData) => {
  try {
    ...
    const accessToken =
      'eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJBY2Nlc3NUb2tlbiIsImlkIjozLCJuaWNrbmFtZSI6ImltVGhpcmQiLCJwcm9maWxlIjoiL2ltZy9kZWZhdWx0Iiwicm9sZSI6IlVTRVIiLCJleHAiOjE3MzMyMzgwNDJ9.lrxh7jbkOTmV2pdrlvIKfV0xrozvYuyqhLhaBYCZva7FgAHNzMqIuL9kzax12mWRTUH-L0hv8vBqZh2NQHGzxg';
